...
Requires Python 3.12+. Last validated against Databricks CLI 1.3.0. Dagshund reads `databricks bundle plan -o json`, whose JSON shape can change between CLI releases.
