...
- `~` `jobs/data_quality_pipeline` — update
  - `+` `tasks[task_key='aggregate_results'].depends_on[task_key='check_duplicates']`: {task_key: "check_duplicates"}
  - `+` `tasks[task_key='aggregate_results'].depends_on[task_key='check_referential_integrity']`: {task_key: "check_referential_integrity"}
  ...
  - `+` `tasks[task_key='compute_statistics'].depends_on[task_key='check_duplicates']`: {task_key: "check_duplicates"}
  - `+` `tasks[task_key='generate_report'].depends_on[task_key='anomaly_detection']`: {task_key: "anomaly_detection"}
